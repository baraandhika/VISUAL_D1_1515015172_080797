 ...
 * @author bara
 */
public class FromBiodata extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("JENIS KELAMAIN");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FromBiodata.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FromBiodata().setVisible(true);
            }
        });
    }
